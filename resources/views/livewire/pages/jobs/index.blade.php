                            ...
                            @foreach ($jobs as $job)
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3 text-center">
                                        ...
                                        alt="{{ $job['company']['name'] ?? 'N/A' }}">
                                    </td>
                                    <td><span class="font-medium text-gray-900">{{ $job['company']['name'] ?? 'N/A'}}</span></td>  
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex items-center flex-wrap gap-2">
                                            @php
                                                $extraInfoArray = explode(', ', $job['extra_info']); // Split values by comma and space
                                            @endphp

                                            @foreach ($extraInfoArray as $info)
